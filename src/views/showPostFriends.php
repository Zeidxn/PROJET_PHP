...
$postsPerPage = 10;
$posts = $postControllerPost->getPostsByUser($friendId, $currentPage, $postsPerPage);
?>
...
<div id="pagination">
    <?php
    $totalPosts = $postControllerPost->getPostsCountByUser($friendId);
    ...
    for ($i = 1; $i <= $totalPages; $i++) {
        echo '<a class="' . ($page == $i ? 'active' : '') . '" href="?page=' . $i . '&userId=' . $friendId . '">' . $i . '</a>';
    }
    ?>
</div>
